...
class customer
{
	...
	public function insert_customer($data){
		...
		if($name == "" || $city =="" || $zipcode =="" || $email=="" || $address =="" || $country =="" || 
			$phone =="" || $password =="" ){
			...
			if($result_check){
				...
				$alert ="<span class ='error'>The Email Already Existed</span>";
				return $alert; 
			...
			if($result){
				...
				$alert ="<span class ='error'> Customer Created Not Successy</span>";
				return $alert;
			}
	...
	public function login_customer($data){
		...
		if($email == "" || $password =="" ){
			...
			$alert ="<span class ='error'>Emails and Password Must Be Not  Empty</span>";
			return $alert;
			...
			if($result_check != false){
				...
				Session::set('customer_logi', true);
